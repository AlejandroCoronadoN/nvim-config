...
alias vz='cd ~ ;vim .zshrc'
alias vision='conda activate reece-vision; aws sso login; export AWS_PROFILE=OCR_DEV; uvicorn main:app'
...
alias dockertest='sudo docker-compose build; sudo docker-compose up --force-recreate -d; sudo docker-compose logs -f -t'
alias dockernocache='sudo docker-compose build --no-cache'
